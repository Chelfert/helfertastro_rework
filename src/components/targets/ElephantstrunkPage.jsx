...
const ElephantstrunkPage = () => {
  return (
    <div className="min-h-screen bg-gray-900">
      <Navigation />
      <TargetPage
        title={`Helfert Astrophotography`}
        mainImage={`/pictures/elephantstrunk.jpg`}
        locationImage={`/Locations/ElephantsTrunk.png`}
        acquisitionDate={`
            Acquisition: SkyWatcher 130-PDS. August, 2022
            
                
                Download Elephant's Trunk Nebula
...
export default ElephantstrunkPage;